...
class GloDataDispatcher extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'glodata:dispatcher';
     ...
     * @var string
     */
    protected $description = 'For dispatching GLO Data Only';
    ...
    private function fetchData() {
        $fetchPendings = Transaction::where(['category' => 'data', 'status' => '0'])->where('description', 'like', '%glo%')->limit(1)->get();
            ...
            foreach($fetchPendings as $pendingIndex => $pendingOrder) {
                ...
                if($theProduct !== false) {
                    ...
                    if($vendorCode != 'localserver') {
                        ...
                        self::updateOrder($uniqueReference, $sendToProvider, $vendorCode);          
                    }
                }
            }
        }
