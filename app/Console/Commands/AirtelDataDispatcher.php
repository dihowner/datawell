...
class AirtelDataDispatcher extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'airteldata:dispatcher';
     ...
     * @var string
     */
    protected $description = 'For dispatching Airtel Data Only';
    ...
    private function fetchData() {
        $fetchPendings = Transaction::where(['category' => 'data', 'status' => '0'])->where('description', 'like', '%airtel%')->limit(1)->get();
