...
<html lang="en">
  <head>
    ...
    <title>Pricing | The Data Well Nigerai</title>
  </head>
  <body>
    ...
    <main id="main" class="hide-on-mobile-nav">
      ...
      <section id="price-details" class="container mx-auto px-8 md:px-24">
        <div
          class="space-y-20 py-14 md:py-20 2xl:py-32 md:space-y-32 lg:space-y-40 xl:space-y-60 container_fluid"
        >
          <div class="max-w-xs mx-auto md:max-w-none">
            ...
            <div
              class="md:flex mt-5 space-y-10 md:mt-8 lg:mt-10 md:space-y-0 lg:space-x-4 md:between-start"
            >
              <div
                data-aos="fade-up"
                data-aos-once="true"
              ...
              >
                ...
                <div class="mt-8 space-y-4 lg:space-y-8 md:mt-12 lg:mt-16">
                  ...
                  >
                    <span class="text-gray-500">3.9GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦900</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-center lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">20GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦7200</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-center lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">26GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦9000</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-center lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">42GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦13500</span>
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div class="mt-8 space-y-4 lg:space-y-8 md:mt-12 lg:mt-16">
                  ...
                  >
                    <span class="text-gray-500">500MB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦140</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">1GB</span
                    ><span class="text-gray-500">=&gt;</span
                  ...
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">2GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦460</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">5GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦1150</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">10GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦2300</span>
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div class="mt-8 space-y-4 lg:space-y-8 md:mt-12 lg:mt-16">
                  ...
                  >
                    <span class="text-gray-500">500MB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦475</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">1.536GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦950</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">2.048GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦1140</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">3.072GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦1425</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">4.608GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦1900</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">11.264GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦3800</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">15.36GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦4750</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">40.96GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦9500</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    data-aos-once="true"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">76.8GB</span
                    ><span class="text-gray-500">=&gt;</span
                    ><span class="font-bold text-gray-800">₦14250</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div
              class="mt-5 md:flex space-y-10 lg:mt-10 lg:space-x-10 lg:between-start lg:space-y-0"
            >
              <div
                data-aos="fade-up"
                data-aos-once="true"
              ...
              >
                ...
                <div class="px-4 mt-4 space-y-4 lg:mt-8 lg:space-y-8">
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">DSTV</span
                  ...
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">GOTV</span
                    ><span class="font-bold text-gray-800">1%</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">STARTIMES</span
                  ...
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">SMILE RECHARGE</span
                  ...
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">SPECTRANET</span
                    ><span class="font-bold text-gray-800">2.5%</span>
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div class="px-4 mt-4 space-y-4 lg:mt-8 lg:space-y-8">
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">MTN</span
                    ><span class="font-bold text-gray-800">2%</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">MTN - PREMIUM</span
                  ...
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">AIRTEL</span
                    ><span class="font-bold text-gray-800">3%</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">9MOBILE</span
                  ...
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">9MOBILE - PREMIUM</span
                  ...
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">GLO</span
                    ><span class="font-bold text-gray-800">5%</span>
                  </p>
                  <p
                    data-aos="fade-up"
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">GLO - PREMIUM</span
                  ...
                  <p
                    ...
                    class="space-x-4 text-sm flex justify-between lg:space-x-8 between md:text-base"
                  >
                    <span class="text-gray-500">VISAPHONE</span
                    ><span class="font-bold text-gray-800">5%</span>
                  </p>
                </div>
              </div>
