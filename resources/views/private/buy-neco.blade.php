                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex">
                                            <img src="{{ asset($necoPackages[0]['image_url']) }}" alt="img"
                                                class="w-10 m-1">
                                        </div>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('user.submit-education-request') }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <select class="form-control form-control-lg serviceType"
                                                    ...
                                                    @if (count($necoPackages) > 0)
                                                        @foreach ($necoPackages as $necoProduct)
                                                            @php
                                                                $pricing = $necoProduct['productpricing'];
                                                                $totalPrice = $pricing['selling_price'] + $pricing['extra_charges'];
                                                            @endphp
                                                            <option value="{{ $necoProduct['product_id'] }}" data-name="{{ $necoProduct['product_name'] }}"
                                                                data-price="{{ $totalPrice }}">
                                                                {{ $necoProduct['product_name'] }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                        ...
                                        <button type="submit" class="btn btn-danger btn-block btn-lg mt-4 mb-0 payBtn">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
