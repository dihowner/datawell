                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex">
                                            <img src="{{ asset($aedcPackages[0]['image_url']) }}" alt="img"
                                                class="w-10 m-1">
                                        </div>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('user.submit-electricity-request') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg serviceType" name="serviceType">
                                                ...
                                                @if (count($aedcPackages) > 0)
                                                    @foreach ($aedcPackages as $aedcProduct)
                                                        @php
                                                            $pricing = $aedcProduct['productpricing'];
                                                            $totalPrice = $pricing['extra_charges'];
                                                        @endphp
                                                        <option value="{{ $aedcProduct['product_id'] }}"
                                                            data-price="{{ $totalPrice }}"
                                                            data-name="{{ $aedcProduct['product_name'] }}"
                                                            @if ($aedcProduct['availability'] == '0') disabled @endif>
                                                            {{ $aedcProduct['product_name'] }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
