                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex">
                                            <img src="{{ asset($phedcPackages[0]['image_url']) }}" alt="img"
                                                class="w-10 m-1">
                                        </div>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('user.submit-electricity-request') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg serviceType" name="serviceType">
                                                ...
                                                @if (count($phedcPackages) > 0)
                                                    @foreach ($phedcPackages as $phedcProduct)
                                                        @php
                                                            $pricing = $phedcProduct['productpricing'];
                                                            $totalPrice = $pricing['extra_charges'];
                                                        @endphp
                                                        <option value="{{ $phedcProduct['product_id'] }}"
                                                            data-name="{{ $phedcProduct['product_name'] }}" data-price="{{ $totalPrice }}"
                                                            @if ($phedcProduct['availability'] == '0') disabled @endif>
                                                            {{ $phedcProduct['product_name'] }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
