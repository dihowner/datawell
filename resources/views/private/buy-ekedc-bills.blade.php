                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex">
                                            <img src="{{ asset($ekedcPackages[0]['image_url']) }}" alt="img"
                                                class="w-10 m-1">
                                        </div>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('user.submit-electricity-request') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg serviceType" name="serviceType">
                                                ...
                                                @if (count($ekedcPackages) > 0)
                                                    @foreach ($ekedcPackages as $ekedcProduct)
                                                        @php
                                                            $pricing = $ekedcProduct['productpricing'];
                                                            $totalPrice = $pricing['extra_charges'];
                                                        @endphp
                                                        <option value="{{ $ekedcProduct['product_id'] }}"
                                                            data-name="{{ $ekedcProduct['product_name'] }}" data-price="{{ $totalPrice }}"
                                                            @if ($ekedcProduct['availability'] == '0') disabled @endif>
                                                            {{ $ekedcProduct['product_name'] }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
