                                    ...
                                    <form method="post" action="{{ route('user.submit-data-request') }}">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-control form-control-lg bundleCategory"
                                                ...
                                                @if (count($airtelDataCategories) > 0)
                                                    @foreach ($airtelDataCategories as $airtelDataCategory)
                                                        <option value="{{ $airtelDataCategory['category_name'] }}">
                                                            {{ $airtelDataCategory['category_name'] }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
