                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex">
                                            <img src="{{ asset($ibedcPackages[0]['image_url']) }}" alt="img"
                                                class="w-10 m-1">
                                        </div>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('user.submit-electricity-request') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg serviceType" name="serviceType">
                                                ...
                                                @if (count($ibedcPackages) > 0)
                                                    @foreach ($ibedcPackages as $ibedcProduct)
                                                        @php
                                                            $pricing = $ibedcProduct['productpricing'];
                                                            $totalPrice = $pricing['extra_charges'];
                                                        @endphp
                                                        <option value="{{ $ibedcProduct['product_id'] }}"
                                                            data-name="{{ $ibedcProduct['product_name'] }}" data-price="{{ $totalPrice }}"
                                                            @if ($ibedcProduct['availability'] == '0') disabled @endif>
                                                            {{ $ibedcProduct['product_name'] }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
