                ...
                <div class="side-app">
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title">Conversion History</h3>
                                </div>
                                <div class="card-body p-2">

                                    <form method="GET" action="{{ route('user.search-airtime-conv') }}">
                                        <div class="row form-group p-3">
                                            ...
                                            <div class="col-sm-2 col-xs-4 mb-2">
                                                <a href="{{ route('user.airtimeconv-history') }}" class="btn btn-dark btn-lg btn-block"><i class="fa fa-refresh"></i>
                                                    Refresh</a>
                                            </div>
                                        </div>
                                    </form>
                                            ...
                                            <tbody>
                                                @if (count($userConversions) > 0)
                                                    @php
                                                        $i = 1;
                                                    @endphp
                                                    @foreach ($userConversions->sortByDesc('created_at') as $record)
                                                        @php
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="d-block text-primary">Sent From
                                                                    {{ $record['airtime_sender'] }} to
                                                                    {{ $record['airtime_reciever'] }} </span>
                                                            ...
                                                            <td>{!! $UtilityService->walletStatusBySpan($record['status']) !!}</td>
                                                            <td>
                                                                <a
                                                                    href="{{ route('view-airtime', ['reference' => $referenceId]) }}">
