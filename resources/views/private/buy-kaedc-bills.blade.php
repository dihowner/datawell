                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex">
                                            <img src="{{ asset($kaedcPackages[0]['image_url']) }}" alt="img"
                                                class="w-10 m-1">
                                        </div>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('user.submit-electricity-request') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg serviceType" name="serviceType">
                                                ...
                                                @if (count($kaedcPackages) > 0)
                                                    @foreach ($kaedcPackages as $kaedcProduct)
                                                        @php
                                                            $pricing = $kaedcProduct['productpricing'];
                                                            $totalPrice = $pricing['extra_charges'];
                                                        @endphp
                                                        <option value="{{ $kaedcProduct['product_id'] }}"
                                                            data-name="{{ $kaedcProduct['product_name'] }}" data-price="{{ $totalPrice }}"
                                                            @if ($kaedcProduct['availability'] == '0') disabled @endif>
                                                            {{ $kaedcProduct['product_name'] }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
