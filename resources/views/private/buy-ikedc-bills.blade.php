                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex">
                                            <img src="{{ asset($ikedcPackages[0]['image_url']) }}" alt="img"
                                                class="w-10 m-1">
                                        </div>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('user.submit-electricity-request') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg serviceType" name="serviceType">
                                                ...
                                                @if (count($ikedcPackages) > 0)
                                                    @foreach ($ikedcPackages as $ikedcProduct)
                                                        @php
                                                            $pricing = $ikedcProduct['productpricing'];
                                                            $totalPrice = $pricing['extra_charges'];
                                                        @endphp
                                                        <option value="{{ $ikedcProduct['product_id'] }}"
                                                            data-name="{{ $ikedcProduct['product_name'] }}" data-price="{{ $totalPrice }}"
                                                            @if ($ikedcProduct['availability'] == '0') disabled @endif>
                                                            {{ $ikedcProduct['product_name'] }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
