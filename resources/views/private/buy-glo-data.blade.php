                                    ...
                                    <form method="post" action="{{ route('user.submit-data-request') }}">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <select class="form-control form-control-lg bundleCategory"
                                                ...
                                                @if (count($gloDataCategories) > 0)
                                                    @foreach ($gloDataCategories as $gloDataCategory)
                                                        <option value="{{ $gloDataCategory['category_name'] }}">
                                                            {{ $gloDataCategory['category_name'] }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
