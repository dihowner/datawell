                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex">
                                            <img src="{{ asset($kedcPackages[0]['image_url']) }}" alt="img"
                                                class="w-10 m-1">
                                        </div>
                                    </div>
                                    ...
                                    <form method="post" action="{{ route('user.submit-electricity-request') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-lg serviceType" name="serviceType">
                                                ...
                                                @if (count($kedcPackages) > 0)
                                                    @foreach ($kedcPackages as $kedcProduct)
                                                        @php
                                                            $pricing = $kedcProduct['productpricing'];
                                                            $totalPrice = $pricing['extra_charges'];
                                                        @endphp
                                                        <option value="{{ $kedcProduct['product_id'] }}"
                                                            data-name="{{ $kedcProduct['product_name'] }}" data-price="{{ $totalPrice }}"
                                                            @if ($kedcProduct['availability'] == '0') disabled @endif>
                                                            {{ $kedcProduct['product_name'] }}
                                                        </option>
                                                    @endforeach
                                                @endif
                                            </select>
