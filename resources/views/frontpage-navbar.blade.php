...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('node_modules/a11y-slider/dist/a11y-slider.css') }}" />
...
<body>
    ...
    <section class="static">
        <nav class="container md:mb-10" id="nav">
            ...
            <div class="lg:hidden flex items-center container mx-auto py-4 justify-between" id="menuItems">
                    ...
                    <div id="mobileMenuContainer" class="lg:hidden">
                        <ul id="mobileMenu"
                            ...
                            <li
                                ...
                                <a href="http://datawellng.com">Home</a>
                            </li>
                            <li
                ...
                <a href="login"
                    ...
                    <svg class="w-4 h-4 mr-2 fill-white text-base" focusable="false" aria-hidden="true"
                        viewBox="0 0 24 24" data-testid="HttpsOutlinedIcon">
                        <path
                ...
                <a href="http://datawellng.com">
                    <img alt="The Data Well Logo" loading="lazy" width="1288" height="1288" decoding="async"
                        data-nimg="1" class="w-16 lg:hidden mr-4" src="images/The Data Well logo oppo.png" />
                </a>
            </div>
            ...
            <div class="relative text-white lg:w-full hidden lg:block z-[999999999999999]">
                <div
                    class="absolute bg-[#D10A22] top-0 left-0 -z-[1] lg:block h-[72px] lg:w-[80%] xl:w-[60%] 2xl:w-[50%]">
                </div>
                <ul class="space-x-8 flex mx-auto px-20 text-white">
                    ...
                    <li class="relative px-16 py-6 space-x-2 font-bold tracking-wide cursor-pointer loginLi center">
                        <a href="login" class="flex flex-row items-center">
                            ...
                            <span>Login</span>
                            <svg class="w-6 h-6 mr-2 fill-white" focusable="false" aria-hidden="true"
                                viewBox="0 0 24 24" data-testid="NavigateNextRoundedIcon">
                                <path
        ...
        <a href="http://datawellng.com" class="absolute z-50 w-16 lg:w-24 xl:w-32 right-10 top-2 lg:top-8">
