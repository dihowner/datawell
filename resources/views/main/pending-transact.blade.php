...
<body class="app sidebar-mini light-mode default-sidebar">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <div class="mb-0">
                                        <h3 class="card-title mb-0">Pending Transaction Histories</h3>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive mb-2 mt-3">
                                        ...
                                        <div class="alert alert-info">
                                            <strong class="fs-18"><i class="fa fa-bell"></i>
                                             All transaction showing here are yet to deliver
                                            to the recipient </strong>
                                        </div>
    ...
    <script>
        ...
        $(".refundTransaction").on("click", function() {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "You want to refund orders, You won't be able to revert this!",
                icon: 'warning',
                showCancelButton: true,
                ...
                if (result.isConfirmed) {
                    form.append('<input type="hidden" name="action" value="refund">');
                    // Proceed with form submission
                    form.submit();
                } else if (result.dismiss === Swal.DismissReason.cancel) {
                    Swal.fire('Cancelled', 'Request not processed', 'info');
