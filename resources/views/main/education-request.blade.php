...
<body class="app sidebar-mini light-mode default-sidebar">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <div class="mb-0">
                                        <h3 class="card-title mb-0">Education Requests</h3>
                                    </div>
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <div class="table-responsive mb-2">
                                        <table
                                            ...
                                            <tbody>
                                                @if (count($educationRequests) > 0)
                                                    @php
                                                        $i = 1;
                                                    @endphp
                                                    @foreach ($educationRequests as $educationRequest)
                                                        @php
                                                            $productName = isset($educationRequest->product->product_name) ? $educationRequest->product->product_name : '';
                                                            $requestId = $educationRequest->id;
                                                            
                                                            $mobileNigCode = $educationRequest->mobilenig;
                                                        @endphp
                                                        <tr>
                                                            <td>{{ $i }}</td>
                                                            <td>
                                                                <div class="d-flex align-items-center mb-6">
                                                                    <div class="mr-3"
                                                                        style="background-image: url({{ asset($educationRequest['image_url']) }}); width: 50px; height: 50px; background-size: cover;">
                                                                    </div>
                                                                    <div>
                                                                        <strong>{{ $productName }}</strong>
                                                                        <div class="d-block">
                                                                            {{ $educationRequest->product_id }}</div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>{{ $mobileNigCode }} </td>
                                                        ...
                                                        <div class="modal fade" id="editRequest{{ $requestId }}"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <form method="POST"
                                                                    action="{{ route('update-education-request', ['id' => $requestId]) }}">
                                                                    @method('PUT')
                                                                    @csrf
    ...
    @include('components.modals.education-request')
        ...
        $(".deleteBtn").on("click", function() {
            ...
            Swal.fire({
                ...
                html: "You want to delete " + productName +
                    " education Request code. Purchase of service for " + productName +
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = '/main/education-request/' + requestId + '/delete';
                } else if (result.dismiss === Swal.DismissReason.cancel) {
                    Swal.fire('Cancelled', 'Your education request code is safe', 'info');
                }
            });
