...
<body class="app sidebar-mini light-mode default-sidebar">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <div class="mb-0">
                                        <h3 class="card-title mb-0">Airtime Requests</h3>
                                    </div>
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <div class="table-responsive mb-2">
                                        <table
                                            ...
                                            <tbody>
                                                @if (count($airtimeRequests) > 0)
                                                    @php
                                                        $i = 1;
                                                    @endphp
                                                    @foreach ($airtimeRequests as $airtimeRequest)
                                                        @php
                                                            $productName = isset($airtimeRequest->product->product_name) ? $airtimeRequest->product->product_name : '';
                                                            $requestId = $airtimeRequest->id;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center mb-6">
                                                                    <div class="mr-3"
                                                                        style="background-image: url({{ asset($airtimeRequest['image_url']) }}); width: 50px; height: 50px; background-size: cover;">
                                                                    </div>
                                                                    <div>
                                                                        <strong>{{ $productName }}</strong>
                                                                        <div class="d-block">
                                                                            {{ $airtimeRequest->product_id }}</div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>{{ $initCode }} </td>
                                                        ...
                                                        <div class="modal fade" id="editRequest{{ $requestId }}"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <form method="POST"
                                                                    action="{{ route('update-airtime-request', ['id' => $requestId]) }}">
                                                                    @method('PUT')
                                                                    @csrf
    ...
    @include('components.modals.airtime-request')
        ...
        $(".deleteBtn").on("click", function() {
            ...
            Swal.fire({
                ...
                html: "You want to delete " + productName +
                    " Airtime Request code. Purchase of service for " + productName +
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = '/main/airtime-request/' + requestId + '/delete';
                } else if (result.dismiss === Swal.DismissReason.cancel) {
                    Swal.fire('Cancelled', 'Your airtime request code is safe', 'info');
                }
            });
