                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        <div class="text-center">
                            <span class="dropdown-item text-center user pb-0 font-weight-bold">{{ Str::ucfirst($userDetail->username) }}</span>
                            <div class="dropdown-divider"></div>
                        </div>
                        <a class="dropdown-item d-flex" href="{{ route('user.profile') }}">
                            <div class="mt-1">Profile</div>
                        </a>
                        <a class="dropdown-item d-flex" href="{{ route('user.pin-password-view') }}">
                            <div class="mt-1">Settings</div>
                        </a>
                        <a class="dropdown-item d-flex" href="{{ route('user.transactions') }}">
                            <div class="mt-1">My Transactions</div>
                        </a>
                        <a class="dropdown-item d-flex" href="{{ route('user.sign-out') }}">
