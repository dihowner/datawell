<div class="modal fade" id="createProductModal" tabindex="-1" role="dialog" aria-labelledby="normalmodal"
    ...
    <div class="modal-dialog" role="document">
        <form method="POST" action="{{ route('create-airtime-request') }}">
            @csrf
                ...
                <div class="modal-body">
                    <div class="form-group mb-2">
                        ...
                        <select class="form-control form-control-lg select2-show-search" name="product_id">
                            @if (count($airtimeProducts))
                                @foreach ($airtimeProducts as $airtimeProduct)
                                    <option value="{{ $airtimeProduct->product_id }}">
                                        {{ $airtimeProduct->product_name }}
                                    </option>
                                @endforeach
                            @endif
                        </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mb-2">
                            <label for="serviceType" class="form-label">SMEPlug</label>
                            <input class="form-control form-control-lg" name="smeplug" placeholder="Enter smeplug code">
                        </div>
                         
                        <div class="col-md-6 form-group mb-2">
                            <label for="serviceType" class="form-label">Ipay</label>
